...
extern "C" void hotspot3D(INTERFACE_WIDTH tempIn[GRID_ROWS * GRID_COLS* GRID_LAYERS/WIDTH_FACTOR], 
              INTERFACE_WIDTH powerIn[GRID_ROWS * GRID_COLS* GRID_LAYERS/WIDTH_FACTOR],
              INTERFACE_WIDTH tempOut[GRID_ROWS * GRID_COLS * GRID_LAYERS/WIDTH_FACTOR]);
