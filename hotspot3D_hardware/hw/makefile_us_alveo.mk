...
$(TEMP_DIR)/hotspot3D.xo: src/hotspot3D.cpp
	mkdir -p $(TEMP_DIR)
	v++ $(VPP_FLAGS) $(VPP_FLAGS_$(MY_KERNEL_NAME)) -c -k hotspot3D --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' '$<'
#################Make Your Changes Here####################
...
#################Make Your Changes Here####################
$(BUILD_DIR)/$(MY_KERNEL_NAME).xclbin: $(TEMP_DIR)/hotspot3D.xo
	mkdir -p $(BUILD_DIR)
